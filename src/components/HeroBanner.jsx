...
const HeroBanner = () => {
     return (
          <Box sx={{ mt: { lg: "212px", xs: "70px" }, ml: { sm: "50px" } }} position="relative" p="20px">
               <Typography color="#ff2655" fontWeight="600px" fontSize="26px">Fitness Club</Typography>
               ...
               <img src={HeroImg} alt="banner" className='hero-banner-img' style={{ borderBottomLeftRadius: "30px" }} />
          </Box >
     );
}
